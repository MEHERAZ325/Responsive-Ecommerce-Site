            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center'>
                ...
                <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                    ...
                    <p className='text-sm text-gray-500 tracking-wide leading-5'>
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Reiciendis, doloribus fugiat, recusandae corporis ab quo sequi suscipit, tempore eos perspiciatis modi maxime omnis ipsam facere iste consequuntur nam officiis obcaecati?
                    </p>
